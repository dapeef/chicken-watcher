    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chicken', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='chicken_watcher.chicken')),
                ('nesting_box', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='chicken_watcher.nestingbox')),
            ],
        ),
        migrations.CreateModel(
